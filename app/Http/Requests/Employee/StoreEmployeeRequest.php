...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nik_ktp' => ['nullable', 'string', 'max:32', Rule::unique('employees', 'nik_ktp')->where('tenant_id', $tenantId)],
            'npwp' => ['nullable', 'string', 'max:32', Rule::unique('employees', 'npwp')->where('tenant_id', $tenantId)],
            'email' => ['nullable', 'email', 'max:255', Rule::unique('employees', 'email')->where('tenant_id', $tenantId)],
