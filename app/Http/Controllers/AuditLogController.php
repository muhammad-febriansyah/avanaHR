...
/**
 * Tenant-scoped audit trail. Read-only view for auditors / admins of their own
 * tenant's sensitive changes (the platform viewer is cross-tenant). Tenant
 * isolation is enforced by the AuditLog model's global scope.
 */
class AuditLogController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('audit-logs/index', [
            'breadcrumbs' => [
                ...
                ['title' => 'Audit Log', 'href' => route('audit-logs.index')],
            ],
            'logs' => $logs,
    ...
    private function eventOptions(): array
    {
        return [
            ...
            ['value' => 'payroll.approved', 'label' => 'Payroll Disetujui'],
            ['value' => 'payroll.paid', 'label' => 'Payroll Dibayar'],
        ];
    }
}
